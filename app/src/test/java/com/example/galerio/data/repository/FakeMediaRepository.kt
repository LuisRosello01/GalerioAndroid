 ...
 */
class FakeMediaRepository : MediaRepository(null, null, mockk(relaxed = true), null) {
    ...
    override suspend fun forceRefresh(): Result<List<MediaItem>> {
